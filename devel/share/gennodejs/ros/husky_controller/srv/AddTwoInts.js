...
// (in-package husky_controller.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'husky_controller/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'husky_controller/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'husky_controller/AddTwoInts'; }
};
